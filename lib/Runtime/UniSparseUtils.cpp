...
#undef IMPL_NEWUNISPARSETENSOR
  ...
  index_type getTensorDim(void* ptr, index_type dim) {
    ...
    void _mlir_ciface_kernel_dia_spmm(StridedMemRefType<float, 2> *outC,
        ...
        UniSparseStorage<DataType>* spA = (UniSparseStorage<DataType>*)inA;
    ...
    UniSparseStorage<DataType>* sparT = (UniSparseStorage<DataType>*)(ptr);
  ...
  void _mlir_ciface_kernel_bdia_spmv_iter(StridedMemRefType<DataType, 1> *outC,
        ...
        DataType sum;
        UniSparseStorage<DataType>* spA_CSR = (UniSparseStorage<DataType>*)inA_CSR;
        UniSparseStorage<DataType>* spA_BDIA = (UniSparseStorage<DataType>*)inA_BDIA;
        ...
        // std::cout << (end0-start0)*1000/runs << std::endl;
...
//    std::vector<float> values(sparT->valueArray);
    ...
    auto T_BDIA = new UniSparseStorage<DataType>();
...
//    std::vector<float> values(sparT->valueArray);
  ...
  void* _mlir_ciface_decompose_BELL_COO(void* ptr, int32_t blockSize, float block_thres, float col_thres) {
    ...
    // step 1: initialize vectorArray
    auto T_BELL = new UniSparseStorage<DataType>();
