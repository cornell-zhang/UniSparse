// sparlay-opt ./sparlay_csc_sd2d.mlir -sparlay-codegen -lower-format-conversion -lower-struct -dce | \
...
module {
  ...
  func.func @csc_sparse_dense_add(%arg0: tensor<?x?xf32, #CSC>, %arg1: tensor<?x?xf32>, %argx: tensor<?x?xf32>) -> tensor<?x?xf32> {
  ...
  func.func @main() {
    ...
    %a1 = sparlay.convert (%A_ori): tensor<?x?xf32, #COO> to tensor<?x?xf32, #CSC>
    ...
    %o1 = bufferization.alloc_tensor(%c256, %c256) : tensor<?x?xf32>

    %1 = call @csc_sparse_dense_add(%a1, %b, %o1) : (tensor<?x?xf32, #CSC>, tensor<?x?xf32>, tensor<?x?xf32>) -> tensor<?x?xf32>
...
//    bufferization.dealloc_tensor %o1 : tensor<?x?xf32>
