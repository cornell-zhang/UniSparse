// sparlay-opt ./sparlay_coo_spmm.mlir -sparlay-codegen -lower-format-conversion -lower-struct -dce | \
...
// clang++ coo_spmm.o -L$SPLHOME/build/lib -lmlir_sparlay_runner_utils \
...
module {
  ...
  func.func @main() {
    ...
    %0 = sparlay.coo_spmm %A_0, %init_256_4, %o0_4_4: tensor<?x?xf32, #COO>, memref<?x?xf32>, memref<?x?xf32> to memref<?x?xf32>
