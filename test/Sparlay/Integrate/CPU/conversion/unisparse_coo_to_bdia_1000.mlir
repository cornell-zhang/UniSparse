...
#BDIA = #sparlay.encoding<{
  crdMap = #sparlay.crd<(i,j)->(i floordiv 1000, j minus i, i mod 1000)>,
...
//    sparlay.printStorage (%a_ori): tensor<?x?xf32, #COO>
    ...
    %a2 = sparlay.convert (%a1): tensor<?x?xf32, #COO> to tensor<?x?xf32, #BDIA>
//    sparlay.printStorage (%a2): tensor<?x?xf32, #BDIA>
    %t_end0 = call @rtclock() : () -> f64
    %t_0 = arith.subf %t_end0, %t_start0: f64
    vector.print %t_0 : f64

    %a3 = sparlay.convert (%a2): tensor<?x?xf32, #BDIA> to tensor<?x?xf32, #COO>
