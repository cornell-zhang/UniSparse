...
//    %10 = call @sptGrow(%9, %c0_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %11 = call @sptVectorize(%7, %c2_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %12 = call @sptSum(%2, %c0_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %13 = call @sptEnumerate(%12, %c1_i32, %c1_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %14 = call @sptMove(%13, %c0_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %15 = call @sptCustPad(%14, %c1_i32, %c1_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %16 = call @rtclock() : () -> f64
    %t_0 = arith.subf %16, %3: f64
