...
#CISR = #sparlay.encoding<{
  ...
  layout = #sparlay.layout<partition(0)>
}>
...
#hiSparse = #sparlay.encoding<{
  crdMap = #sparlay.crd<(i,j)->(i,j)>,
  compressMap = #sparlay.compress<fuse(0), trim(1,1)>,
  layout = #sparlay.layout<pack(1,2)>
}>
...
module {
  ...
  func.func @main() {
    ...
    %A_hiSparse = sparlay.convert (%A_COO): tensor<?x?xf32, #COO> to tensor<?x?xf32, #hiSparse>
