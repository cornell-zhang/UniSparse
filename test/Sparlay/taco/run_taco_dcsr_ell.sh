rm dcsr_to_ell
g++ -std=c++11 -O3 -DNDEBUG -DTACO -I/work/shared/users/staff/zz546/taco/include -L/work/shared/users/staff/zz546/taco/build/lib coo_dia.cpp -o dcsr_to_ell -ltaco
...
do
    echo ./dcsr_to_ell $dataset
    ./dcsr_to_ell $DATASET_PATH/$dataset 6
done
