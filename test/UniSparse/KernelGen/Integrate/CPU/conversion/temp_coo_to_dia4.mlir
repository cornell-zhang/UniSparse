module {
  ...
  func.func @main() {
    ...
    %13 = call @sptAdd(%12, %c1_i32_1, %c0_i32_0) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %14 = call @sptSub(%13, %c0_i32_0, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %15 = call @sptNeg(%14, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
