module {
  ...
  func.func @main() {
    ...
    %5 = call @sptNeg(%4, %c0_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    ...
    %11 = call @sptDevectorize(%8, %c1_i32_1) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %12 = call @sptSeparate(%11, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %13 = call @sptSub(%12, %c0_i32_0, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %14 = call @sptNeg(%13, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %15 = call @sptMove(%14, %c0_i32_0, %c0_i32_0) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %16 = call @sptMove(%15, %c1_i32_1, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    call @sptPrint(%16) : (!llvm.ptr<i8>) -> ()
    call @sptCheck(%16, %1) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%1) : (!llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%16) : (!llvm.ptr<i8>) -> ()
    return
  }
}
