module {
  ...
  func.func @main() {
    ...
    %4 = call @sptTileSplit(%2, %c1_i32, %c3_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %5 = call @sptTileSplit(%4, %c0_i32, %c2_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %6 = call @sptMove(%5, %c0_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %7 = call @sptMove(%6, %c2_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    ...
    %14 = call @sptDevectorize(%11, %c2_i32_2) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %15 = call @sptTrim(%14, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %16 = call @sptSeparate(%15, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %17 = call @sptSeparate(%16, %c1_i32_1) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %18 = call @sptMove(%17, %c3_i32_3, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %19 = call @sptMove(%18, %c3_i32_3, %c3_i32_3) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %20 = call @sptTileMerge(%19, %c2_i32_2, %c2_i32_2) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %21 = call @sptTileMerge(%20, %c0_i32_0, %c3_i32_3) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %22 = call @sptSwap(%21, %c0_i32_0, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %23 = call @sptMove(%22, %c0_i32_0, %c0_i32_0) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    call @sptPrint(%23) : (!llvm.ptr<i8>) -> ()
    call @sptCheck(%23, %1) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%1) : (!llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%23) : (!llvm.ptr<i8>) -> ()
    return
  }
}
