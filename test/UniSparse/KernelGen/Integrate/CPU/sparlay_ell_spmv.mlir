...
module {
  ...
  func.func @kernel_ell_spmv(%arg0: tensor<?x?xf32, #ELL>, %arg1: tensor<?xf32>, %argx: tensor<?xf32>) -> tensor<?xf32> {
    %0 = linalg.generic #trait1
    ins(%arg0, %arg1 : tensor<?x?xf32, #ELL>, tensor<?xf32>)
  ...
  func.func @main() {
    ...
    %D_0 = sparlay.convert(%A_1) : tensor<?x?xf32, #COO> to tensor<?x?xf32, #ELL>
    ...
    %result1 = call @kernel_ell_spmv(%D_0, %b, %o11) : (tensor<?x?xf32, #ELL>, tensor<?xf32>, tensor<?xf32>) -> tensor<?xf32>
