// unisparse-opt ./decompose-BDIA.mlir -lower-struct-convert -lower-struct -dce -unisparse-codegen -lower-format-conversion | \
...
module {
  ...
  func.func @main() {
    ...
    // block DIA SpMV
    %result1 = unisparse.bdia_spmm %D_0, %B_1, %b, %o1: 
