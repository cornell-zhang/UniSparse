// unisparse-opt ./unisparse_dcsc_spmv_F64.mlir -unisparse-codegen -lower-format-conversion -lower-struct -dce | \
...
// -reconcile-unrealized-casts  | mlir-translate -mlir-to-llvmir | opt -O3 -S | llc -O3 -relocation-model=pic -filetype=obj -o dcsc_spmv_F64.o

// clang++ dcsc_spmv_F64.o -L$SPLHOME/build/lib -lmlir_unisparse_runner_utils \
//         -L$LLVM_ROOT/build/lib -lmlir_runner_utils -lmlir_c_runner_utils -o dcsc_spmv_F64
