// unisparse-opt ./unisparse_dcsc_spmm_F32.mlir -unisparse-codegen -lower-format-conversion -lower-struct -dce | \
...
// -reconcile-unrealized-casts  | mlir-translate -mlir-to-llvmir | opt -O3 -S | llc -O3 -relocation-model=pic -filetype=obj -o dcsc_spmm_F32.o

// clang++ dcsc_spmm_F32.o -L$SPLHOME/build/lib -lmlir_unisparse_runner_utils \
//         -L$LLVMHOME/build/lib -lmlir_runner_utils -lmlir_c_runner_utils -o dcsc_spmm_F32
