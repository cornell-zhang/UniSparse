// unisparse-opt test/UniSparse/linalg.mlir -unisparse-codegen
...
module {
  ...
  func.func @entry() {
    ...
    %a_1 = unisparse.fromFile (%fileName): !llvm.ptr<i8> to tensor<?x?xi32, #COO>
    %a = unisparse.convert (%a_1): tensor<?x?xi32, #COO> to tensor<?x?xi32, #CSR>
