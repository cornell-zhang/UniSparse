module {
  ...
  func.func @main() {
    ...
    %10 = call @sptGrow(%9, %c1_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    ...
    %13 = call @sptTrim(%10, %c0_i32_2) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %14 = call @sptSeparate(%13, %c0_i32_2) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %15 = call @sptSeparate(%14, %c1_i32_3) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %16 = call @sptMove(%15, %c2_i32_4, %c1_i32_3) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %17 = call @sptMove(%16, %c3_i32_5, %c3_i32_5) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %c3_i32_8 = arith.constant 3 : i32
    %18 = call @sptTileMerge(%17, %c2_i32_4, %c3_i32_8) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %c2_i32_9 = arith.constant 2 : i32
    %19 = call @sptTileMerge(%18, %c0_i32_2, %c2_i32_9) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
