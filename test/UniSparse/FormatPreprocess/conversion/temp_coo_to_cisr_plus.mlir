module {
  ...
  func.func @main() {
    ...
    %7 = call @sptSum(%6, %c0_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %8 = call @sptSchedule(%7, %c0_i32, %c0_i32, %c5_i32) : (!llvm.ptr<i8>, i32, i32, i32) -> !llvm.ptr<i8>
    ...
    call @delSparlayTensor(%11) : (!llvm.ptr<i8>) -> ()
    return
  }
}
