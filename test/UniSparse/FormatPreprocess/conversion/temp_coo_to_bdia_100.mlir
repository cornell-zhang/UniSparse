...
//    %6 = call @sptMove(%5, %c0_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    ...
    %7 = call @sptTileSplit(%5, %c1_i32, %c100_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    ...
    %c100_i32_6 = arith.constant 100 : i32
    %21 = call @sptTileMerge(%20, %c0_i32_0, %c100_i32_6) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
