module {
  ...
  func.func @main() {
    ...
    %6 = call @sptNeg(%5, %c0_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %7 = call @sptMove(%6, %c0_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %8 = call @sptFuse(%7, %c0_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %9 = call @sptVectorize(%8, %c1_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    call @sptPrint(%9) : (!llvm.ptr<i8>) -> ()
    %10 = call @rtclock() : () -> f64
    ...
    %12 = call @sptDevectorize(%9, %c1_i32_1) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %13 = call @sptSeparate(%12, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %14 = call @sptSub(%13, %c1_i32_1, %c0_i32_0) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %15 = call @sptAdd(%14, %c0_i32_0, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %16 = call @sptMove(%15, %c0_i32_0, %c0_i32_0) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %17 = call @sptMove(%16, %c1_i32_1, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    call @sptPrint(%17) : (!llvm.ptr<i8>) -> ()
    call @sptCheck(%17, %1) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%1) : (!llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%17) : (!llvm.ptr<i8>) -> ()
    return
  }
}
