module {
  ...
  func.func private @sptPack(!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8> attributes {llvm.emit_c_interface}
  ...
  func.func @main() {
    ...
    %c5_i32 = arith.constant 8 : i32
    %4 = call @sptSum(%2, %c0_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %5 = call @sptReorder(%4, %c0_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %6 = call @sptTileSplit(%5, %c0_i32, %c2_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %7 = call @sptSum(%6, %c1_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %8 = call @sptEnumerate(%7, %c0_i32, %c3_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %9 = call @sptMove(%8, %c0_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %10 = call @sptMove(%9, %c1_i32, %c1_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %11 = call @sptMove(%10, %c2_i32, %c2_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %12 = call @sptCustPad(%11, %c2_i32, %c2_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
//    %13 = call @sptMove(%12, %c0_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
//    %14 = call @sptMove(%13, %c1_i32, %c1_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
//    %15 = call @sptMove(%14, %c2_i32, %c2_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
//    %16 = call @sptPack(%15, %c3_i32, %c4_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
//    
    %17 = call @rtclock() : () -> f64
    %18 = arith.subf %17, %3 : f64
    vector.print %18 : f64
    call @delSparlayTensor(%1) : (!llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%12) : (!llvm.ptr<i8>) -> ()
    return
  }
}
