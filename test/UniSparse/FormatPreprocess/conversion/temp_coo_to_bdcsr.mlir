module {
  ...
  func.func @main() {
    ...
    %10 = call @sptVectorize(%9, %c2_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    call @sptPrint(%10) : (!llvm.ptr<i8>) -> ()
    %11 = call @rtclock() : () -> f64
    %12 = arith.subf %11, %3 : f64
    vector.print %12 : f64
    ...
    %13 = call @sptDevectorize(%10, %c2_i32_2) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %14 = call @sptSeparate(%13, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %15 = call @sptSeparate(%14, %c1_i32_1) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %16 = call @sptMove(%15, %c2_i32_2, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %17 = call @sptMove(%16, %c3_i32_3, %c3_i32_3) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %18 = call @sptTileMerge(%17, %c2_i32_2, %c3_i32_3) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %19 = call @sptTileMerge(%18, %c0_i32_0, %c2_i32_2) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    call @sptPrint(%19) : (!llvm.ptr<i8>) -> ()
    call @sptCheck(%19, %1) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%1) : (!llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%19) : (!llvm.ptr<i8>) -> ()
    return
  }
}
