module {
  ...
  func.func @main() {
    ...
    %10 = call @sptFuse(%9, %c2_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %11 = call @sptGrow(%10, %c2_i32) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    ...
    %14 = call @sptTrim(%11, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %15 = call @sptSeparate(%14, %c0_i32_0) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %16 = call @sptSeparate(%15, %c1_i32_1) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %17 = call @sptSeparate(%16, %c2_i32_2) : (!llvm.ptr<i8>, i32) -> !llvm.ptr<i8>
    %18 = call @sptMove(%17, %c2_i32_2, %c1_i32_1) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %19 = call @sptMove(%18, %c3_i32_3, %c3_i32_3) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %20 = call @sptTileMerge(%19, %c2_i32_2, %c3_i32_3) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %21 = call @sptTileMerge(%20, %c0_i32_0, %c2_i32_2) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    call @sptPrint(%21) : (!llvm.ptr<i8>) -> ()
    call @sptCheck(%21, %1) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%1) : (!llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%21) : (!llvm.ptr<i8>) -> ()
    return
  }
}
