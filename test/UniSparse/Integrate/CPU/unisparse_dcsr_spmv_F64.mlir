// unisparse-opt ./unisparse_dcsr_spmv_F64.mlir -unisparse-codegen -lower-format-conversion -lower-struct -dce | \
...
// -reconcile-unrealized-casts  | mlir-translate -mlir-to-llvmir | opt -O3 -S | llc -O3 -relocation-model=pic -filetype=obj -o dcsr_spmv_F64.o

// clang++ dcsr_spmv_F64.o -L$SPLHOME/build/lib -lmlir_unisparse_runner_utils \
//         -L$LLVMHOME/build/lib -lmlir_runner_utils -lmlir_c_runner_utils -o dcsr_spmv_F64
...
module {
  ...
  func.func @main() {
    ...
    %A_2 = unisparse.fromFile (%fileName) : !Filename to tensor<?x?xf64, #COO>
    %c256 = tensor.dim %A_2, %c1 : tensor<?x?xf64, #COO>
    %a2 = unisparse.convert (%A_2): tensor<?x?xf64, #COO> to tensor<?x?xf64, #DCSR>
