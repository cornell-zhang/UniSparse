rm csr_to_csc
g++ -std=c++11 -O3 -DNDEBUG -DTACO -I/work/shared/users/staff/zz546/taco/include -L/work/shared/users/staff/zz546/taco/build/lib coo_dia.cpp -o csr_to_csc -ltaco
...
do
    ...
    ./csr_to_csc $DATASET_PATH/$dataset 2
done
