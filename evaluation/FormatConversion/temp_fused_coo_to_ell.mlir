module {
  ...
  func.func private @sptFusedEnumeratePad(!llvm.ptr<i8>, i32, i32, i32) -> !llvm.ptr<i8> attributes {llvm.emit_c_interface}
  ...
  func.func @main() {
    ...
    %9 = call @sptFusedEnumeratePad(%6, %c1_i32, %c1_i32, %c1_i32) : (!llvm.ptr<i8>, i32, i32, i32) -> !llvm.ptr<i8>
    %12 = call @rtclock() : () -> f64
