module {
  ...
  func.func private @sptFusedDIA2D(!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8> attributes {llvm.emit_c_interface}
  ...
  func.func @main() {
    ...
    %4 = call @sptFusedDIA2D(%2, %c5_i32, %c0_i32) : (!llvm.ptr<i8>, i32, i32) -> !llvm.ptr<i8>
    %9 = call @rtclock() : () -> f64
    %10 = arith.subf %9, %3 : f64
    vector.print %10 : f64
    call @delSparlayTensor(%1) : (!llvm.ptr<i8>) -> ()
    call @delSparlayTensor(%4) : (!llvm.ptr<i8>) -> ()
    return
  }
}
