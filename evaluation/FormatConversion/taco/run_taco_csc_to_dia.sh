rm coo_to_dia
g++ -std=c++11 -O3 -DNDEBUG -DTACO -I/work/shared/users/staff/zz546/taco/include -L/work/shared/users/staff/zz546/taco/build/lib coo_dia.cpp -o csc_to_dia -ltaco
...
do
    echo ./csc_to_dia $dataset
    ./csc_to_dia $DATASET_PATH/$dataset 4
