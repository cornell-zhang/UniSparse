make cusparse_hybrid_bsr_coo_spmv
...
for ((i=0;i<${#DATSETS1[@]};i++)); do
    echo ${BUILD_DIR}/cusparse_hybrid_bsr_coo_spmv ${DATSETS1[i]} ${DATSETS2[i]}
    ${BUILD_DIR}/cusparse_hybrid_bsr_coo_spmv $DATASET_PATH/${DATSETS1[i]} $DATASET_PATH/${DATSETS2[i]}
done
