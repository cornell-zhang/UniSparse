...
module {
  ...
  func.func @kernel_csr_spgemm(%arg0: tensor<?x?xf64, #CSR>, %arg1: tensor<?x?xf64, #CSC>, %dim0: index, %dim1: index) -> tensor<?x?xf64, #CSC> {
    %0 = bufferization.alloc_tensor(%dim0, %dim1) : tensor<?x?xf64, #CSC>
    %1 = linalg.generic #trait1
    ins(%arg0, %arg1 : tensor<?x?xf64, #CSR>, tensor<?x?xf64, #CSC>)
  ...
  func.func @main() {
    ...
    %0 = call @kernel_csr_spgemm(%a0, %a1, %dim0, %dim1) : (tensor<?x?xf64, #CSR>, tensor<?x?xf64, #CSC>, index, index) -> tensor<?x?xf64, #CSC>
