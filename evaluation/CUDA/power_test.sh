make cusparse_spmv cusparse_spmm cusparse_spgemm
...
do
    ...
    echo ${BUILD_DIR}/cusparse_spmm $dataset
    ${BUILD_DIR}/cusparse_spmm $DATASET_PATH/$dataset

    echo ${BUILD_DIR}/cusparse_spgemm $dataset
    ${BUILD_DIR}/cusparse_spgemm $DATASET_PATH/$dataset
done
