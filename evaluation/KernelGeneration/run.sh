...
clang++ sparse_tensor_csr_spmm_F64.o -L$SPLHOME/build/lib -lmlir_sparlay_runner_utils -L$LLVM_ROOT/build/lib -lmlir_runner_utils -lmlir_c_runner_utils -o sparse_tensor_csr_spmm_F64
...
clang++ sparse_tensor_dcsc_spmm_F64.o -L$SPLHOME/build/lib -lmlir_sparlay_runner_utils -L$LLVM_ROOT/build/lib -lmlir_runner_utils -lmlir_c_runner_utils -o sparse_tensor_dcsc_spmm_F64
...
clang++ sparse_tensor_csr_csr_csr_spgemm_F64.o -L$SPLHOME/build/lib -lmlir_unisparse_runner_utils -L$LLVM_ROOT/build/lib -lmlir_runner_utils -lmlir_c_runner_utils -o sparse_tensor_csr_csr_csr_spgemm_F64
...
clang++ sparse_tensor_csc_csc_csc_spgemm_F64.o -L$SPLHOME/build/lib -lmlir_unisparse_runner_utils -L$LLVM_ROOT/build/lib -lmlir_runner_utils -lmlir_c_runner_utils -o sparse_tensor_csc_csc_csc_spgemm_F64
